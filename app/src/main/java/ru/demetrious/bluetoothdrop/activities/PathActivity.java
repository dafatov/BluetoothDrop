...
public class PathActivity extends AppCompatActivity {
    public final static String EXTRA_PARENT_SETTING = "ru.demetrious.bluetoothdrop.parent_setting";
    public final static String EXTRA_CURRENT_DIR = "ru.demetrious.bluetoothdrop.current_dir";
    public final static String EXTRA_HOME = "ru.demetrious.bluetoothdrop.home";
